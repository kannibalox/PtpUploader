...
def UnitTest():
    def MakeTestItem(codec, container, source, resolution, remasterTitle, sizeText):
        return PtpMovieSearchResultItem(
            0,
            "",
            codec,
            container,
    ...
    if True:
        ...
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "", "8000 MB")
        )
        searchResult.UhdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "40000 MB")
        )
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080i", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("H.264", "MKV", "Blu-ray", "1080p", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("MPEG-2", "MKV", "Blu-ray", "1080p", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("VC-1", "MKV", "Blu-ray", "1080p", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("H.265", "MKV", "Blu-ray", "4K", "Remux", "8000 MB"),
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "8000 MB"),
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.264", "MKV", "Blu-ray", "4K", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x265", "MKV", "Blu-ray", "4K", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("H.265", "MKV", "Blu-ray", "4K", "", "8000 MB"),
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x265", "MKV", "Blu-ray", "4K", "", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.264", "MKV", "Blu-ray", "4K", "", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "DVD", "1x1", "", "700 MB")
        )
        searchResult.SdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "1x1", "", "700 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "HD-DVD", "720p", "", "4500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "", "8000 MB")
        )
        ...
        searchResult.UhdList.append(
            MakeTestItem("H.265", "MKV", "Blu-ray", "4K", "Remux", "53000 MB")
        )

        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("XviD", "AVI", "Blu-ray", "1x1", "", "700 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "HD-DVD", "1x1", "", "700 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "Blu-ray", "720p", "", "4500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x265", "MKV", "Blu-ray", "4K", "", "40000 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "DVD", "1x1", "", "1400 MB")
        )
        searchResult.SdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "1x1", "", "1400 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "HD-DVD", "720p", "", "6500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "", "12500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "Remux", "12500 MB")
        )
        searchResult.UhdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "30000 MB")
        )
        searchResult.UhdList.append(
            MakeTestItem("H.265", "MKV", "Blu-ray", "4K", "Remux", "53500 MB")
        )
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "Remux", "16000 MB"),
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("XviD", "AVI", "Blu-ray", "1x1", "", "1400 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "HD-DVD", "1x1", "", "1400 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "Blu-ray", "720p", "", "6500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080i", "Remux", "12500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "45000 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.265", "MKV", "Blu-ray", "4K", "Remux", "70000 MB"),
        )
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "RC", "1080p", "", "8000 MB")
        )
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "RC", "1080p", "Remux", "8000 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult, False, MakeTestItem("x264", "MKV", "RC", "4K", "", "8000 MB")
        )
        IsReleaseExists(
            searchResult,
            False,
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "RC", "1080i", "Remux", "8000 MB")
        )
    ...
    if True:
        ...
        searchResult.SdList.append(
            MakeTestItem("x264", "MKV", "DVD", "1x1", "", "700 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "HD-DVD", "720p", "", "4500 MB")
        )
        ...
        searchResult.UhdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "35000 MB")
        )
        searchResult.UhdList.append(
            MakeTestItem("H.265", "MKV", "Blu-ray", "4K", "Remux", "35000 MB")
        )

        IsReleaseExists(
            searchResult, True, MakeTestItem("XviD", "AVI", "VHS", "1x1", "", "1400 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "DVD-Screener", "1x1", "", "1400 MB"),
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "WEB", "1x1", "", "1400 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "HDTV", "720p", "", "6500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "RC", "1080p", "", "12500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "WEB", "1080p", "", "12500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "RC", "1080i", "Remux", "12500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "RC", "1080p", "Remux", "12500 MB"),
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "RC", "4K", "", "52500 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.265", "MKV", "RC", "4K", "Remux", "52500 MB"),
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "WEB", "4K", "", "52500 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.265", "MKV", "WEB", "4K", "Remux", "52500 MB"),
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult, True, MakeTestItem("XviD", "AVI", "R5", "1x1", "", "1400 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "WEB", "720p", "", "6500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "WEB", "720p", "", "4500 MB"),
        )
        IsReleaseExists(
            searchResult,
            True,
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.UhdList.append(
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "700 MB")
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "HDTV", "4K", "", "6500 MB")
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "WEB", "4K", "", "4500 MB")
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "RC", "4K", "", "12500 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.265", "MKV", "RC", "4K", "Remux", "12500 MB"),
        )
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "R5", "1x1", "", "700 MB")
        )
        searchResult.SdList.append(
            MakeTestItem("x264", "MKV", "R5", "1x1", "", "700 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "RC", "720p", "", "4500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "RC", "1080p", "", "8000 MB")
        )
        ...
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "R5", "1x1", "", "1400 MB")
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "RC", "720p", "", "6500 MB")
        )
        IsReleaseExists(
            searchResult,
            True,
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "CAM", "1x1", "", "700 MB")
        )
        searchResult.SdList.append(
            MakeTestItem("x264", "MKV", "TV", "1x1", "", "700 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "HDTV", "720p", "", "4500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "WEB", "720p", "", "4500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "RC", "1080p", "", "4500 MB")
        )

        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("XviD", "AVI", "DVD-Screener", "1x1", "", "700 MB"),
        )
        IsReleaseExists(
            searchResult, False, MakeTestItem("x264", "MKV", "R5", "1x1", "", "700 MB")
        )
        IsReleaseExists(
            searchResult,
            False,
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "CAM", "1x1", "", "1400 MB")
        )
        searchResult.SdList.append(
            MakeTestItem("x264", "MKV", "TV", "1x1", "", "1400 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "WEB", "1x1", "", "1400 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "HDTV", "720p", "", "6500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "HDTV", "720p", "", "12500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "WEB", "1080p", "", "6500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "RC", "1080p", "Remux", "12500 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "WEB", "4K", "", "6500 MB")
        )

        IsReleaseExists(
            searchResult, False, MakeTestItem("XviD", "AVI", "DVD", "1x1", "", "700 MB")
        )
        IsReleaseExists(
            searchResult,
            False,
        ...
        IsReleaseExists(
            searchResult, False, MakeTestItem("x264", "MKV", "DVD", "1x1", "", "700 MB")
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "DVD", "1x1", "", "1400 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "HD-DVD", "1080p", "", "8500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "HD-DVD", "1080p", "", "12500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080i", "Remux", "4500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "Remux", "4500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080i", "Remux", "6500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "1080p", "Remux", "6500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "Blu-ray", "4K", "", "6500 MB"),
        )
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "HDTV", "1x1", "", "1400 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "WEB", "1080p", "", "6500 MB")
        )
        ...
        IsReleaseExists(
            searchResult, True, MakeTestItem("XviD", "AVI", "WEB", "1x1", "", "1400 MB")
        )
        IsReleaseExists(
            searchResult,
            False,
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("x264", "MKV", "HDTV", "1080p", "", "6500 MB"),
        )
        IsReleaseExists(
            searchResult,
            False,
        ...
        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("x264", "MKV", "RC Blu-ray", "1080p", "", "6500 MB"),
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "WEB", "4K", "", "6500 MB")
        )
        IsReleaseExists(
            searchResult,
            False,
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult, False, MakeTestItem("x264", "MKV", "WEB", "4K", "", "6500 MB")
        )
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "WEB", "1x1", "", "700 MB")
        )
        searchResult.HdList.append(
            MakeTestItem("x264", "MKV", "WEB", "720p", "", "4400 MB")
        )
        searchResult.UhdList.append(
            MakeTestItem("x264", "MKV", "WEB", "4K", "", "20000 MB")
        )

        IsReleaseExists(
            searchResult, True, MakeTestItem("XviD", "AVI", "WEB", "1x1", "", "700 MB")
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("XviD", "AVI", "WEB", "1x1", "", "1400 MB")
        )
        ...
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "WEB", "4K", "", "5000 MB")
        )
        IsReleaseExists(
            searchResult, True, MakeTestItem("x264", "MKV", "WEB", "4K", "", "50000 MB")
        )
    ...
    if True:
        ...
        IsReleaseExists(
            searchResult,
            True,
            MakeTestItem("H.264", "MKV", "WEB", "720p", "", "4400 MB"),
        )
    ...
    if True:
        searchResult = PtpMovieSearchResult("1", None)
        searchResult.UhdList.append(
            MakeTestItem("H.264", "MKV", "WEB", "4K", "", "4400 MB")
        )
        ...
        IsReleaseExists(
            searchResult, True, MakeTestItem("H.265", "MKV", "WEB", "4K", "", "6500 MB")
        )
    ...
    if True:
        ...
        searchResult.SdList.append(
            MakeTestItem("XviD", "AVI", "DVD-Screener", "1x1", "", "1400 MB")
        )

        IsReleaseExists(
            searchResult,
            False,
            MakeTestItem("XviD", "AVI", "WEB", "1x1", "", "1400 MB"),
        )
